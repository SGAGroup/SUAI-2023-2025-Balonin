...
function _DrawVagon() {
  ...
  const cube_366Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_366Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_366 = new THREE.Mesh(cube_366Geometry, Train_blueMaterial);
  ...
  const cube_367Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_367Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_367 = new THREE.Mesh(cube_367Geometry, Train_blueMaterial);
  ...
  const cube_368Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_368Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_368 = new THREE.Mesh(cube_368Geometry, GlassMaterial);
  ...
  const cube_369Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_369Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_369 = new THREE.Mesh(cube_369Geometry, ColoumnMaterial);
  ...
  const cube_369GroupMY = cube_369Group.clone();
  ...
  const cube_369GroupMirroredY = new THREE.Group();
  cube_369GroupMirroredY.add(cube_369Group, cube_369GroupMY);
  cube_369GroupMirroredY.position.set(-9.8261, 0, -2.4191);
  const cube_370Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_370Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_370 = new THREE.Mesh(cube_370Geometry, ColoumnMaterial);
  ...
  const cube_371Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_371Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_371 = new THREE.Mesh(cube_371Geometry, Train_blueMaterial);
  ...
  const cube_375Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_375Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_375 = new THREE.Mesh(cube_375Geometry, Train_blueMaterial);
  ...
  const cube_376Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_376Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_376 = new THREE.Mesh(cube_376Geometry, Train_blueMaterial);
  ...
  const cube_377Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_377Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_377 = new THREE.Mesh(cube_377Geometry, ColoumnMaterial);
  ...
  const cube_377GroupMY = cube_377Group.clone();
  ...
  const cube_377GroupMirroredY = new THREE.Group();
  cube_377GroupMirroredY.add(cube_377Group, cube_377GroupMY);
  cube_377GroupMirroredY.position.set(-10.1767, 0, -2.4191);
  const cube_378Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_378Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_378 = new THREE.Mesh(cube_378Geometry, Train_blueMaterial);
  ...
  const cube_379Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_379Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_379 = new THREE.Mesh(cube_379Geometry, Train_blueMaterial);
  ...
  const cube_380Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_380Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_380 = new THREE.Mesh(cube_380Geometry, Train_blueMaterial);
  ...
  const cube_381Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_381Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_381 = new THREE.Mesh(cube_381Geometry, GlassMaterial);
  ...
  const cube_382Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_382Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_382 = new THREE.Mesh(cube_382Geometry, ColoumnMaterial);
  ...
  const cube_383Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_383Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_383 = new THREE.Mesh(cube_383Geometry, ColoumnMaterial);
  ...
  const cube_384Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_384Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_384 = new THREE.Mesh(cube_384Geometry, ColoumnMaterial);
  ...
  const cube_385Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_385Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_385 = new THREE.Mesh(cube_385Geometry, ColoumnMaterial);
  ...
  const cube_385GroupMY = cube_385Group.clone();
  ...
  const cube_385GroupMirroredY = new THREE.Group();
  cube_385GroupMirroredY.add(cube_385Group, cube_385GroupMY);
  cube_385GroupMirroredY.position.set(-10.5352, 0, -2.4191);
  const cube_386Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_386Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_386 = new THREE.Mesh(cube_386Geometry, ColoumnMaterial);
  ...
  const cube_386GroupMY = cube_386Group.clone();
  ...
  const cube_386GroupMirroredY = new THREE.Group();
  cube_386GroupMirroredY.add(cube_386Group, cube_386GroupMY);
  cube_386GroupMirroredY.position.set(-8.7227, 0, -2.4191);
  const cube_387Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_387Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_387 = new THREE.Mesh(cube_387Geometry, ColoumnMaterial);
  ...
  const cube_387GroupMY = cube_387Group.clone();
  ...
  const cube_387GroupMirroredY = new THREE.Group();
  cube_387GroupMirroredY.add(cube_387Group, cube_387GroupMY);
  cube_387GroupMirroredY.position.set(-9.4318, 0, -2.4191);
  const cube_388Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_388Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_388 = new THREE.Mesh(cube_388Geometry, ColoumnMaterial);
  ...
  const cube_388GroupMY = cube_388Group.clone();
  ...
  const cube_388GroupMirroredY = new THREE.Group();
  cube_388GroupMirroredY.add(cube_388Group, cube_388GroupMY);
  cube_388GroupMirroredY.position.set(-9.0851, 0, -2.4191);
  const cube_389Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_389Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_389 = new THREE.Mesh(cube_389Geometry, Train_blueMaterial);
  ...
  const cube_390Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_390Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_390 = new THREE.Mesh(cube_390Geometry, Train_blueMaterial);
  ...
  const cube_391Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_391Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_391 = new THREE.Mesh(cube_391Geometry, GlassMaterial);
  ...
  const cube_392Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_392Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_392 = new THREE.Mesh(cube_392Geometry, ColoumnMaterial);
  ...
  const cube_392GroupMY = cube_392Group.clone();
  ...
  const cube_392GroupMirroredY = new THREE.Group();
  cube_392GroupMirroredY.add(cube_392Group, cube_392GroupMY);
  cube_392GroupMirroredY.position.set(-9.8261, 0, 2.4259);
  const cube_393Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_393Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_393 = new THREE.Mesh(cube_393Geometry, ColoumnMaterial);
  ...
  const cube_394Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_394Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_394 = new THREE.Mesh(cube_394Geometry, Train_blueMaterial);
  ...
  const cube_395Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_395Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_395 = new THREE.Mesh(cube_395Geometry, Train_blueMaterial);
  ...
  const cube_396Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_396Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_396 = new THREE.Mesh(cube_396Geometry, Train_blueMaterial);
  ...
  const cube_397Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_397Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_397 = new THREE.Mesh(cube_397Geometry, ColoumnMaterial);
  ...
  const cube_397GroupMY = cube_397Group.clone();
  ...
  const cube_397GroupMirroredY = new THREE.Group();
  cube_397GroupMirroredY.add(cube_397Group, cube_397GroupMY);
  cube_397GroupMirroredY.position.set(-10.1767, 0, 2.4259);
  const cube_398Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_398Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_398 = new THREE.Mesh(cube_398Geometry, Train_blueMaterial);
  ...
  const cube_399Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_399Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_399 = new THREE.Mesh(cube_399Geometry, Train_blueMaterial);
  ...
  const cube_400Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_400Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_400 = new THREE.Mesh(cube_400Geometry, Train_blueMaterial);
  ...
  const cube_401Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_401Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_401 = new THREE.Mesh(cube_401Geometry, GlassMaterial);
  ...
  const cube_402Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_402Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_402 = new THREE.Mesh(cube_402Geometry, ColoumnMaterial);
  ...
  const cube_403Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_403Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_403 = new THREE.Mesh(cube_403Geometry, ColoumnMaterial);
  ...
  const cube_404Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_404Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_404 = new THREE.Mesh(cube_404Geometry, ColoumnMaterial);
  ...
  const cube_405Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_405Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_405 = new THREE.Mesh(cube_405Geometry, ColoumnMaterial);
  ...
  const cube_405GroupMY = cube_405Group.clone();
  ...
  const cube_405GroupMirroredY = new THREE.Group();
  cube_405GroupMirroredY.add(cube_405Group, cube_405GroupMY);
  cube_405GroupMirroredY.position.set(-10.5352, 0, 2.4259);
  const cube_406Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_406Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_406 = new THREE.Mesh(cube_406Geometry, ColoumnMaterial);
  ...
  const cube_406GroupMY = cube_406Group.clone();
  ...
  const cube_406GroupMirroredY = new THREE.Group();
  cube_406GroupMirroredY.add(cube_406Group, cube_406GroupMY);
  cube_406GroupMirroredY.position.set(-8.7227, 0, 2.4259);
  const cube_407Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_407Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_407 = new THREE.Mesh(cube_407Geometry, ColoumnMaterial);
  ...
  const cube_407GroupMY = cube_407Group.clone();
  ...
  const cube_407GroupMirroredY = new THREE.Group();
  cube_407GroupMirroredY.add(cube_407Group, cube_407GroupMY);
  cube_407GroupMirroredY.position.set(-9.4318, 0, 2.4259);
  const cube_408Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_408Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_408 = new THREE.Mesh(cube_408Geometry, ColoumnMaterial);
  ...
  const cube_408GroupMY = cube_408Group.clone();
  ...
  const cube_408GroupMirroredY = new THREE.Group();
  ...
  const cube_434Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_434Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_434 = new THREE.Mesh(cube_434Geometry, WhiteDotsMaterial);
  ...
  const cube_435Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_435Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_435 = new THREE.Mesh(cube_435Geometry, WhiteDotsMaterial);
  ...
  const cube_436Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_436Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_436 = new THREE.Mesh(cube_436Geometry, WhiteDotsMaterial);
  ...
  const cube_437Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_437Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_437 = new THREE.Mesh(cube_437Geometry, WhiteDotsMaterial);
  ...
  const cube_438Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_438Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_438 = new THREE.Mesh(cube_438Geometry, ColoumnMaterial);
  ...
  const cube_439Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_439Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_439 = new THREE.Mesh(cube_439Geometry, ColoumnMaterial);
  ...
  const cube_440Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_440Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_440 = new THREE.Mesh(cube_440Geometry, MetalMaterial);
  ...
  const cube_441Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_441Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_441 = new THREE.Mesh(cube_441Geometry, MetalMaterial);
  ...
  const cube_467Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_467Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_467 = new THREE.Mesh(cube_467Geometry, WhiteDotsMaterial);
  ...
  const cube_468Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_468Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_468 = new THREE.Mesh(cube_468Geometry, WhiteDotsMaterial);
  ...
  const cube_469Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_469Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_469 = new THREE.Mesh(cube_469Geometry, WhiteDotsMaterial);
  ...
  const cube_470Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_470Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_470 = new THREE.Mesh(cube_470Geometry, WhiteDotsMaterial);
  ...
  const cube_471Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_471Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_471 = new THREE.Mesh(cube_471Geometry, ColoumnMaterial);
  ...
  const cube_472Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_472Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_472 = new THREE.Mesh(cube_472Geometry, ColoumnMaterial);
  ...
  const cube_473Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_473Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_473 = new THREE.Mesh(cube_473Geometry, MetalMaterial);
  ...
  const cube_474Geometry = new THREE.BoxGeometry(2, 2, 2);
  const cube_474Group = new THREE.Group();
  for (let i = 0; i < 4; i++) {
    const cube_474 = new THREE.Mesh(cube_474Geometry, MetalMaterial);
