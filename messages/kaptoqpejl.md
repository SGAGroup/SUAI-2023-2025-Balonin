...
Поработали с роботом. Пока думаем над роботом-пылесосом, будет по платформе убирать всякое.

Камеру поправили.

# balon

Вместо ESC проще второй клик мышки отцепиться..

В метро робот скорее пол моет, он не пылесос.. поломой.. оснастить вебкамерой на борту, двумя.. сложных движений ему не надо..

Роль ваших то сонаров неясна.. выходит робот имеет камеру и точка зрения имеет камеру, с переключением. У робота сонары замкнуты на алгоритм его езды. У вас сонаров много и зачем они неясно. Это сонары аспекта зрения.

Сонары робота пока не накручиваем много, пусть себе пол моет. С борта видит. Зеленый человечек робот может ходить из точки А в точку B и обратно, не задавить его поломою приостановкой, вот и задача.

Аспект то нас менее интересует, это же просто камера пока. Камера может проехать сквозь ходока, это нормально.

Лучше, когда сонары инициализируются и вызываются примерно одинаковыми по названию подпрограммами. Их три, как я помню. Init, потом Set и Get.

Вы, по сути, подвижный Аспект стали превращать в робот. Насколько это надо, неясно. Зачем камере какие то развитые реакции, ее дело, дать точку зрения. Для реакций у нас есть робот. Может, кардинально упростить, чтобы хурды бурды не было.
